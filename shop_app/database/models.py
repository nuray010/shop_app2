...
from sqlalchemy import Integer, String, Enum, Date, ForeignKey, DateTime, Text, Boolean
...
class Category(Base):
    ...
    def __repr__(self):
        return f'{self.category_name}, {self.subcategories}'
...
class SubCategory(Base):
    ...
    def __repr__(self):
        return f'{self.category}, {self.product_sub}, {self.sub_category_name}'
...
class Product(Base):
    ...
    def __repr__(self):
        return f'{self.subcategory}, {self.product_images}, {self.product_review}'
